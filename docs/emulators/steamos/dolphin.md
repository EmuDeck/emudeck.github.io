...
If you are choosing to create your own profile, it is recommended you read Dolphin's wikipedia page on gyro: [https://wiki.dolphin-emu.org/index.php?title=Motion_evdev](https://wiki.dolphin-emu.org/index.php?title=Motion_evdev).
